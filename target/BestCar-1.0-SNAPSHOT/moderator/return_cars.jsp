                ...
                <c:forEach var="history" items="${requestScope.moderList}">
                    <form class="mb-auto" method="post" action="pick_up">
                        <tr>
                            ...
                            <td>
                                <select class="form-select" id="state" name="damage" required="">
                            ...
                            <td>
                                ...
                                <input type="text" class="form-control" id="description" name="description" placeholder="${inputDescription}" value="" required="">
                            </td>
                            <td>
