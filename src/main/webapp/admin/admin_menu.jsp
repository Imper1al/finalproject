...
<head>
    <meta charset="utf-8">
    <title><fmt:message key="admin.main.title" bundle="${bundle}"/></title>
...
<body>
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column d-flex h-100 text-center text-dark">
        ...
        <main class="px-3 mt-auto">
            <h1 class="mb-4"><fmt:message key="admin.main.main" bundle="${bundle}"/></h1>
            <img src="images/adminmenu.png" height="300px" width="325px" alt="main">
            <h5 class="lead mt-2"><fmt:message key="admin.main.tagline" bundle="${bundle}"/></h5>
        </main>
