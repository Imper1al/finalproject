...
public class UserDaoTest {
    ...
    public void userTest() throws Exception {
        ...
        assertEquals(new UserDaoIml().getUserRole("765765765", "pass"), "User");
        ...
        assertTrue(new UserDaoIml().getActive("765765765"));
        assertTrue(new UserDaoIml().userExists("765765765", "pass"));
        assertTrue(new UserDaoIml().phoneExists("765765765"));
        new UserDaoIml().updateActive(false, "765765765");
        assertFalse(new UserDaoIml().getActive("765765765"));
    }

    @Test
    public void moderatorTest() throws Exception {
        User moderator = new User("Moderator", "Test", "000001111", "test", "Moderator");
        new UserDaoIml().insertModerator(moderator);
        moderID = new UserDaoIml().getUserId("000001111", "test");
